...
class Ui_AboutDialog(object):
    def setupUi(self, AboutDialog):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/icons/fb2tool_48px.png"))
    ...
    def retranslateUi(self, AboutDialog):
        ...
        AboutDialog.setWindowTitle(_translate("AboutDialog", "About Fb2Tool"))
        self.labelName.setText(_translate("AboutDialog", "Fb2Tool v1.0"))
        self.labelAuthor.setText(_translate("AboutDialog", "Written by dnk_dz, fork by asmadeus"))
