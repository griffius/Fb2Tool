...
class Ui_SettingsDialog(object):
    def setupUi(self, SettingsDialog):
        ...
        self.textDefaultDir = FolderPicker(self.tab)
        self.textDefaultDir.setObjectName("textDefaultDir")
        self.verticalLayout_3.addWidget(self.textDefaultDir)
        ...
        spacerItem3 = QtWidgets.QSpacerItem(168, 23, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.label_2.setText(_translate("SettingsDialog", "Default dir"))
        self.label_5.setText(_translate("SettingsDialog", "Reader app for fb2"))
        self.label_6.setText(_translate("SettingsDialog", "Reader app for epub"))
