    ...
    def __init__(self, parent, plugin):
        ...
        for attr_key in self.plugin.__dict__.keys():
            ...
            if isinstance(attr, TextField):
                ...
                widget = QLineEdit()
                widget.textChanged.connect(partial(self.valueChanged, attr_key))

            elif isinstance(attr, BoolField):
                widget = QCheckBox(attr.label, self)
                widget.stateChanged.connect(partial(self.valueChanged, attr_key))
                ...
                widget.currentIndexChanged.connect(partial(self.valueChanged, attr_key))
